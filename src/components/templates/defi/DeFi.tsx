...
import { Box, Grid, GridItem, Text, SimpleGrid ,Heading} from '@chakra-ui/react';
...
setTokenIndex((parseInt(i.toString())+1).toString())
  ...
  return (
    <Box
      ...
      width="full"
      paddingLeft={5}
      height={props.width < 800 ? props.height * 2.2 : props.height * 1.7}
            ...
            >
              <GridItem>
                ...
                >
                  <PlanCard
                    ...
                    descriptionTitle=" Dark matter can be use as currency in the marketplace and games"
                    footer={
                      <Button
                  ...
                  <Box style={{ marginTop: 10, width: '100%', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Text mt={2} mb={5} fontSize="lg" marginLeft={'4%'} textAlign={'center'}>
                      ...
                      <Text mt={10} fontSize="lg" marginLeft={'4%'} textAlign={'center'}>
                        {'Amount Staked: '.concat(deposit).concat(' DKMT')}
                      </Text>
                      <Text mt={2} mb={5} fontSize="lg" marginLeft={'4%'} textAlign={'center'}>
              ...
              <GridItem>
                <SimpleGrid
                  ...
                  justifyContent={'space-between'}
                  alignItems={'space-between'}
                > <Box style={{marginTop: 12,  justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                
                <Heading marginLeft={'0%'}  color={"white"} textAlign={'left'}>
                  {'AIRDROPS FOR MEMBERS'}
                  </Heading> 
                
                  <Text marginLeft={'0%'} marginTop={'10px'} color={"white"} fontSize="1xl" width={300} textAlign={'left'}>
                    {'The Token Id Determines the Rarities of the NFTs, Each rarity determines the % of the monthly Pool you will receive.'}
                  </Text>
