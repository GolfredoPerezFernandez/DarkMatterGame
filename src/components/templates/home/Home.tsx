...
const Home = (props: any) => {
  ...
  const videoOptions = {
    src: 'https://bafybeiclhbykf7v7ydz4g4ojcv7iu5fog4674dobr23gluh2blfoq2gmte.ipfs.w3s.link/0001-0841.mp4',
    ref: (videoRef:any) => {
      videoRef = videoRef;
    },
    onClick: () => {
    ...
    >
      ...
      >
        <Box style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
          ...
          <Text fontSize="lg"  marginTop={10} textAlign={'center'}>
           INTERACTIVE MARKETPLACE WITH DECENTRALIZED FINANCES.
          </Text>
          <Heading fontSize="6xl" marginBottom={20} marginTop={5} textAlign={'center'}>
            EXPLORE NFT COLLECTIONS & PLAY BROWSER GAMES INSPIRED IN THE UNIVERSE.
          </Heading>
      ...
      {props.width < 800 ? (
            ...
            <HStack
              flexDirection={'row'}
              style={{
                overflow: 'hidden', flexDirection: 'row', marginLeft: props.width < 600 ? '0px' : '0px' }}
            >   
     
     <Box style={{ flex: 1, justifyContent: 'center', paddingLeft: '20%', alignItems: 'center' }}>
     <Heading>FUNDING MEMBERS.</Heading>
     <Text>   3% MARKETPLACE FEES </Text>
     <Text>   NFT STAKING</Text>
     <Text>  AIRDROPS</Text>
  
   
             
              <Stack  bgPosition={'center'}
      bgRepeat={'no-repeat'}
      bgImg={'https://bafybeicrpyf7ktu2fe225lawwtb4v2pksv37kcf6mkeja5rwz6rcdddi3e.ipfs.w3s.link/start.png'}
      style={{ flex:1, height:300,width:300,justifyContent: 'center', alignSelf:'center',alignItems: 'center' }}>  
             
                 <Stack style={{ flex: 1, paddingLeft:35,paddingTop:20,justifyContent: 'center', alignSelf:'center', alignItems: 'center' }}>
     ...
     <Text fontSize={20} style={{marginTop:20}} fontWeight={2000}>  Price:</Text>
     
     <Text fontSize={50} style={{marginBottom:10}} fontWeight={5000}>  100 MATIC</Text>
     <Button
              ...
              <Box style={{ flex: 1, justifyContent: 'flex-start', paddingLeft: '0%', alignItems: 'flex-start' }}>  
              <PlanCard
                description={['DAO VOTING']}
                descriptionTitle="With officers you can expand your empire to an extent you've never dreamed of."
                footer={
                  <Button
                    onClick={mintNow}
                    disabled={user ? false : true}
