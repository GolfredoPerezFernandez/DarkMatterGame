...
import { Container, Grid, GridItem, List, ListItem, propNames, VStack } from '@chakra-ui/react';
import { Header } from 'components/modules';
import Head from 'next/head';

import NAV_LINKS from './paths';
import NavItem2 from 'components/elements/navigation/NavItem/NavItem2';
